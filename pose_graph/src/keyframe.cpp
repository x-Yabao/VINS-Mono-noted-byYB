 ...
 * @param[in] _vio_T_w_i 		vio节点中的位置
 * @param[in] _vio_R_w_i 		vio节点中的姿态
...
bool KeyFrame::findConnection(KeyFrame* old_kf)
{
	...
	// Step 1 将关键帧与回环帧进行BRIEF描述子匹配，并剔除匹配失败的点
	...
	*/
	...
	double relative_yaw;
	// Step 2 如果能匹配的特征点能达到最小回环匹配个数，则用RANSAC PnP检测再去除误匹配的点
	...
	// Step 3 如果在PNP检验后仍能达到最小回环匹配点数则进行先对位姿检验，足够才认为回环可能成功
